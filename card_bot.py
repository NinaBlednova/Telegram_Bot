...
bot = TeleBot(token='5919041899:AAGvE8GUAOP7p2JwWtW66Hvy5mrn-ZXn2p8', parse_mode='html') # создание бота
...
def message_handler(message: types.Message):
    ...
    if message.text == 'VISA':
        ...
        bot.send_message(
            ...
            text='Попробуй еще раз, здесь ошибка (())',
        )
        return
